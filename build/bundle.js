    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			h2.textContent = "Equal breathing";
    			t1 = space();
    			pre = element("pre");
    			...
    			attr_dev(h2, "class", "svelte-m98zb2");
    			add_location(h2, file$2, 76, 20, 2255);
    			attr_dev(pre, "class", "svelte-m98zb2");
    			add_location(pre, file$2, 77, 20, 2301);
    			attr_dev(section, "class", "explanation svelte-m98zb2");
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-m98zb2");
    			add_location(h2, file$2, 65, 20, 1727);
    			attr_dev(pre, "class", "svelte-m98zb2");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0 = element("button");
    			h20 = element("h2");
    			h20.textContent = "Box breathing";
    			t4 = space();
    			hr = element("hr");
    			t5 = space();
    			button1 = element("button");
    			h21 = element("h2");
    			h21.textContent = "Equal breathing";
    			t7 = space();
    			div1 = element("div");
    			if_block.c();
    			t8 = space();
    			...
    			attr_dev(img, "class", "svelte-m98zb2");
    			add_location(img, file$2, 39, 8, 835);
    			add_location(p, file$2, 45, 12, 1041);
    			attr_dev(h20, "class", "svelte-m98zb2");
    			add_location(h20, file$2, 51, 16, 1261);

    			attr_dev(button0, "class", button0_class_value = "" + (null_to_empty(/*current*/ ctx[0] === "box"
    			? "selection-btn"
    			: "unselected") + " svelte-m98zb2"));

    			add_location(button0, file$2, 47, 12, 1090);
    			attr_dev(hr, "class", "svelte-m98zb2");
    			add_location(hr, file$2, 53, 12, 1320);
    			attr_dev(h21, "class", "svelte-m98zb2");
    			add_location(h21, file$2, 58, 16, 1513);
    			...
    			attr_dev(div0, "class", "selection svelte-m98zb2");
    			add_location(div0, file$2, 44, 8, 1004);
    			attr_dev(div1, "class", "explanation-container svelte-m98zb2");
    			add_location(div1, file$2, 62, 8, 1588);
    			attr_dev(button2, "id", "jumpto-btn");
    			attr_dev(button2, "class", "svelte-m98zb2");
    			add_location(button2, file$2, 85, 8, 2683);
    			attr_dev(div2, "class", "landing-container svelte-m98zb2");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file, 8, 1, 214);
    			attr_dev(main, "class", "svelte-l2bbuc");
    			add_location(main, file, 14, 0, 330);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
